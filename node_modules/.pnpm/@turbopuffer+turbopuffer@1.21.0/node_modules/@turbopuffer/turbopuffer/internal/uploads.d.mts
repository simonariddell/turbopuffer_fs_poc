 ...
 */
export declare const maybeMultipartFormRequestOptions: (opts: RequestOptions, fetch: Turbopuffer | Fetch) => Promise<RequestOptions>;
type MultipartFormRequestOptions = Omit<RequestOptions, 'body'> & {
    body: unknown;
};
export declare const multipartFormRequestOptions: (opts: MultipartFormRequestOptions, fetch: Turbopuffer | Fetch) => Promise<RequestOptions>;
export declare const createForm: <T = Record<string, unknown>>(body: T | undefined, fetch: Turbopuffer | Fetch) => Promise<FormData>;
export {};
