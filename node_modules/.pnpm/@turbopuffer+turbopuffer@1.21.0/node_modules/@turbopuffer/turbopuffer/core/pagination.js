...
exports.NamespacePage = exports.PagePromise = exports.AbstractPage = void 0;
...
class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new error_1.TurbopufferError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
 ...
 */
class NamespacePage extends AbstractPage {
    constructor(client, response, body, options) {
...
exports.NamespacePage = NamespacePage;
