...
import { TurbopufferError } from "./error.mjs";
...
export class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new TurbopufferError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
 ...
 */
export class NamespacePage extends AbstractPage {
    constructor(client, response, body, options) {
